...
minetest.register_node("stones:rushrock_21u", {
	...
	paramtype2 = "facedir",
	tiles = {"b9_dg_r_r9_1.png"},
	groups = {cvol=0.375, cracky=2, soil=1, not_in_creative_inventory=1},
	light_source = 0,
	drop = "stones:rushrock_21u",
	collision_box = {type="fixed",fixed={
{-0.4687,-0.5,-0.5, 0,0.5,-0.4687},
...
minetest.register_node("stones:diagsterps", {
	description = "*3 Diagonal Steps Rubble",
	paramtype = "light",
	paramtype2 = "facedir",
	tiles = {"rubble.png"},
	groups = {cvol=0.75, cracky=3, oddly_breakable_by_hand=1, not_in_creative_inventory=1},
...
minetest.register_node("stones:dia9s16ps", {
	description = "*3 Diagonal Steps 9/16",
	paramtype = "light",
	paramtype2 = "facedir",
	tiles = {"rock.png"},
	groups = {cvol=0.5625, cracky=1, oddly_breakable_by_hand=1, not_in_creative_inventory=1},
	drop = "stones:dia9s16ps",
	selection_box={type="fixed",fixed={
...
minetest.register_node("stones:d1a6ster9s", {
	description = "*3 Diagonal Steps 9/16 Rubble",
	paramtype = "light",
	paramtype2 = "facedir",
	tiles = {"rubble.png"},
	groups = {cvol=0.5625, cracky=3, oddly_breakable_by_hand=1, not_in_creative_inventory=1, not_in_creative_inventory=1},
	drop = "stones:d1a6ster9s",
	selection_box={type="fixed",fixed={
{-0.5,0,0.0625, -0.4375,0.5,0.125},
{-0.5,0,0.125, -0.375,0.5,0.1875},
{-0.5,0,0.1875, -0.3125,0.5,0.25},
...
minetest.register_node("stones:d1a8s7eps", {
	description = "*3 Diagonal Steps 1+7/16",
	paramtype = "light",
	paramtype2 = "facedir",
	tiles = {"rock.png"},
	groups = {cvol=0.5, cracky=1, oddly_breakable_by_hand=1, not_in_creative_inventory=1},
	drop = "stones:d1a8s7eps",
	selection_box={type="fixed",fixed={
{-0.5,0,0.0625, -0.4375,0.5,0.125},
{-0.5,0,0.125, -0.375,0.5,0.1875},
{-0.5,0,0.1875, -0.3125,0.5,0.25},
...
minetest.register_node("stones:d7a8s1erps", {
	description = "*3 Diagonal Steps 1+7/16 Rubble",
	paramtype = "light",
	paramtype2 = "facedir",
	tiles = {"rubble.png"},
	groups = {cvol=0.5, cracky=3, oddly_breakable_by_hand=1, not_in_creative_inventory=1},
	drop = "stones:d7a8s1erps",
	selection_box={type="fixed",fixed={
{-0.5,0,0.0625, -0.4375,0.5,0.125},
{-0.5,0,0.125, -0.375,0.5,0.1875},
{-0.5,0,0.1875, -0.3125,0.5,0.25},

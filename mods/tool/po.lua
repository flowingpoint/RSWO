...
--		minetest.env:set_node(p, {name="runes:hui", param2=p2lh}) end
		...
		p2s43l = s.param2
		minetest.env:set_node(p, {name="stones:diagsteps_43l", param2=p2s43l}) end
        if s.name == "stones:diagsteps_43l"	then 
		p2s43lr = s.param2
		minetest.env:set_node(p, {name="stones:diagsteps_43r", param2=p2s43lr}) end
        if s.name == "stones:diagsteps_43r"	then 
		p2s4ru = s.param2
		minetest.env:set_node(p, {name="stones:s_21u", param2=p2s4ru}) end
		...
		p2sb4l = s.param2
		minetest.env:set_node(p, {name="stones:diagsterps_43l", param2=p2sb4l}) end
        if s.name == "stones:diagsterps_43l"	then 
		p2sb4lr = s.param2
		minetest.env:set_node(p, {name="stones:diagsterps_43r", param2=p2sb4lr}) end
        if s.name == "stones:diagsterps_43r"	then 
		p2sb4ru = s.param2
		minetest.env:set_node(p, {name="stones:sb_21u", param2=p2sb4ru}) end
        ...
        if s.name == "stones:brushrock_2v"	then 
		p2b2v = s.param2
		minetest.env:set_node(p, {name="stones:blushrock_2v", param2=p2b2v}) end
        if s.name == "stones:blushrock_2v"	then 
		p2lb2v = s.param2
		minetest.env:set_node(p, {name="stones:brushrock_2v", param2=p2lb2v}) end
		...
		p2r3 = s.param2
		minetest.env:set_node(p, {name="stones:brush_3", param2=p2r3}) end
        if s.name == "stones:r_4"	then 
		p2r4 = s.param2
		minetest.env:set_node(p, {name="stones:brush_4", param2=p2r4}) end
		...
		p2br2v = s.param2
		minetest.env:set_node(p, {name="stones:brushrock_2v", param2=p2br2v}) end
		...
		p2brc = s.param2
		minetest.env:set_node(p, {name="stones:rublish_527r", param2=p2brc}) end
        if s.name == "stones:rublish_52ul"	then 
		p2brc = s.param2
		minetest.env:set_node(p, {name="stones:rublish_527l", param2=p2brc}) end
        if s.name == "stones:rublish_28"	then 
		p2brc = s.param2
		minetest.env:set_node(p, {name="stones:rublish_2u", param2=p2brc}) end
        if s.name == "stones:rublish_527r"	then 
		p2brc = s.param2
		minetest.env:set_node(p, {name="stones:rublish_52ur", param2=p2brc}) end
        if s.name == "stones:rublish_527l"	then 
		p2brc = s.param2
		minetest.env:set_node(p, {name="stones:rublish_52ul", param2=p2brc}) end
        if s.name == "stones:rublish_2u"	then 
		p2brc = s.param2
		minetest.env:set_node(p, {name="stones:rublish_28", param2=p2brc}) end
		...
		p2d3dc = s.param2
		minetest.env:set_node(p, {name="stones:s_52d", param2=p2d3dc}) end
        if s.name == "stones:s_52d"	then 
		p2dd7d = s.param2
		minetest.env:set_node(p, {name="stones:diagstep_7", param2=p2dd7d}) end
		...
		p26hja = s.param2
		minetest.env:set_node(p, {name="stones:s_3hjr", param2=p26hja}) end
        if s.name == "stones:s_3hjr"	then 
		p2hj6a = s.param2
		minetest.env:set_node(p, {name="stones:s_62r", param2=p2hj6a}) end
        if s.name == "stones:s_62r"	then 
		p265a = s.param2
		...
		p2rhjrb = s.param2
		minetest.env:set_node(p, {name="stones:sb_62r", param2=p2rhjrb}) end
        if s.name == "stones:sb_62r"	then 
		p2r65b = s.param2
		...
		p2hj6a = s.param2
		minetest.env:set_node(p, {name="stones:s_62l", param2= math.floor(p2hj6a/4)*4+(p2hj6a%4-1)%4}) end
        if s.name == "stones:s_62l"	then 
		p265a = s.param2
		...
		p2rhj6b = s.param2
		minetest.env:set_node(p, {name="stones:sb_62l", param2= math.floor(p2rhj6b/4)*4+(p2rhj6b%4-1)%4}) end
        if s.name == "stones:sb_62l"	then 
		p2r65b = s.param2
		...
		p2r52b= s.param2
		minetest.env:set_node(p, {name="stones:s_52dkl", param2=p2r52b}) end
        if s.name == "stones:s_52dkl"	then 
		p2r52c= s.param2
		minetest.env:set_node(p, {name="stones:s_52dkr", param2=p2r52c}) end
        if s.name == "stones:s_52dkr"	then 
		p2r52d= s.param2
		minetest.env:set_node(p, {name="stones:s_52", param2=p2r52d}) end
		...
		p2z20c= s.param2
		minetest.env:set_node(p, {name="stones:sku20c", param2=p2z20c}) end
        if s.name == "stones:sku20c"	then 
		p220cu= s.param2
		minetest.env:set_node(p, {name="stones:sku", param2=p220cu}) end
        if s.name == "stones:skubl"	then 
		p2skbk = s.param2
		minetest.env:set_node(p, {name="stones:sbukl", param2=p2skbk}) end
        if s.name == "stones:sbukl"	then 
		p2sbkz= s.param2
		minetest.env:set_node(p, {name="stones:sukz", param2=p2sbkz}) end
        if s.name == "stones:sukz"	then 
		p2kz0c= s.param2
		minetest.env:set_node(p, {name="stones:sk0bl2c", param2=p2kz0c}) end
        if s.name == "stones:sk0bl2c"	then 
		p20cbl= s.param2
		minetest.env:set_node(p, {name="stones:skubl", param2=p20cbl}) end
        ...
        if s.name == "stones:rublish_2u"	then 
		p2r2uxa = s.param2
		minetest.env:set_node(p, {name="stones:rublish_2v", param2=p2r2uxa}) end
        if s.name == "stones:rublish_2v"	then 
		p2r2uxb = s.param2
		minetest.env:set_node(p, {name="stones:rublish_2u", param2=p2r2uxb}) end
		...
		p2sc = s.param2
		minetest.env:set_node(p, {name="stones:sku2_lc", param2=p2sc}) end
        if s.name == "stones:sku2_lc"	then 
		p2sr = s.param2
		minetest.env:set_node(p, {name="stones:skus_rc", param2=p2sr}) end
        if s.name == "stones:skus_rc"	then 
		p2sl = s.param2
		minetest.env:set_node(p, {name="stones:sku2_lk", param2=p2sl}) end
        if s.name == "stones:sku2_lk"	then 
		p2k2 = s.param2
		minetest.env:set_node(p, {name="stones:sku2_l", param2=p2k2}) end
        if s.name == "stones:skub2_l"	then 
		p2b2s = s.param2
		minetest.env:set_node(p, {name="stones:skubs_r", param2=p2b2s}) end
        if s.name == "stones:skubs_r"	then 
		p2bsc = s.param2
		minetest.env:set_node(p, {name="stones:skub2_lc", param2=p2bsc}) end
        if s.name == "stones:skub2_lc"	then 
		p2bsr = s.param2
		minetest.env:set_node(p, {name="stones:skubs_rc", param2=p2bsr}) end
        if s.name == "stones:skubs_rc"	then 
		p2brk = s.param2
		minetest.env:set_node(p, {name="stones:skub2_lk", param2=p2brk}) end
        if s.name == "stones:skub2_lk"	then 
		p2bk2 = s.param2
		minetest.env:set_node(p, {name="stones:skub2_l", param2=p2bk2}) end
        if s.name == "stones:sku2_r"	then 
		p22sa = s.param2
		minetest.env:set_node(p, {name="stones:skus_l", param2=p22sa}) end
        if s.name == "stones:skus_l"	then 
		p2sca = s.param2
		minetest.env:set_node(p, {name="stones:sku2_rc", param2=p2sca}) end
        if s.name == "stones:sku2_rc"	then 
		p2sla = s.param2
		minetest.env:set_node(p, {name="stones:skus_lc", param2=p2sla}) end
        if s.name == "stones:skus_lc"	then 
		p2sra = s.param2
		minetest.env:set_node(p, {name="stones:sku2_rk", param2=p2sra}) end
        if s.name == "stones:sku2_rk"	then 
		p2k2a = s.param2
		minetest.env:set_node(p, {name="stones:sku2_r", param2=p2k2a}) end
        if s.name == "stones:skub2_r"	then 
		p22bsa = s.param2
		minetest.env:set_node(p, {name="stones:skubs_l", param2=p22bsa}) end
        if s.name == "stones:skubs_l"	then 
		p2bsca = s.param2
		minetest.env:set_node(p, {name="stones:skub2_rc", param2=p2bsca}) end
        if s.name == "stones:skub2_rc"	then 
		p2bsla = s.param2
		minetest.env:set_node(p, {name="stones:skubs_lc", param2=p2bsla}) end
        if s.name == "stones:skubs_lc"	then 
		p2blka = s.param2
		minetest.env:set_node(p, {name="stones:skub2_rk", param2=p2blka}) end
        if s.name == "stones:skub2_rk"	then 
		p2bk2a = s.param2
		minetest.env:set_node(p, {name="stones:skub2_r", param2=p2bk2a}) end
        if s.name == "stones:spikle"	then 
		p2s52kl = s.param2
		minetest.env:set_node(p, {name="stones:s_52ukl", param2=p2s52kl}) end
        if s.name == "stones:s_52ukl"	then 
		p2sklr = s.param2
		minetest.env:set_node(p, {name="stones:s_52ukr", param2=p2sklr}) end
        if s.name == "stones:s_52ukr"	then 
		p2skr52 = s.param2
		minetest.env:set_node(p, {name="stones:spikle", param2=p2skr52}) end
        if s.name == "stones:sprukle"	then 
		p2sb52kl = s.param2
		minetest.env:set_node(p, {name="stones:s_52bukl", param2=p2sb52kl}) end
        if s.name == "stones:s_52bukl"	then 
		p2sbklr = s.param2
		minetest.env:set_node(p, {name="stones:s_52bukr", param2=p2sbklr}) end
        if s.name == "stones:s_52bukr"	then 
		p2sbkr52 = s.param2
		minetest.env:set_node(p, {name="stones:sprukle", param2=p2sbkr52}) end
		...
		p2yu2 = s.param2
		minetest.env:set_node(p, {name="stones:pyru_2", param2=p2yu2}) end
		...
		p252uuk = s.param2
		minetest.env:set_node(p, {name="stones:s_52uk", param2=p252uuk}) end
        if s.name == "stones:s_52uk"	then 
		p252uvk = s.param2
		minetest.env:set_node(p, {name="stones:s_52vk", param2=p252uvk}) end
        if s.name == "stones:s_52vk"	then 
		p252vku = s.param2
		minetest.env:set_node(p, {name="stones:s_52u", param2=p252vku}) end
        if s.name == "stones:sb_52u"	then 
		p252bur = s.param2
		minetest.env:set_node(p, {name="stones:s_52urk", param2=p252bur}) end
		...
		p2as2 = s.param2
		minetest.env:set_node(p, {name="stones:aset_2", param2=p2as2}) end
        if s.name == "stones:aset_2"	then 
		p2as2u = s.param2
		minetest.env:set_node(p, {name="stones:aset_2u", param2=p2as2u}) end
        if s.name == "stones:aset_2u"	then 
		p2asu = s.param2
		minetest.env:set_node(p, {name="stones:aset", param2=p2asu}) end
        if s.name == "stones:asect"	then 
		p2asc2 = s.param2
		minetest.env:set_node(p, {name="stones:asect_2", param2=p2asc2}) end
		...
		p2asru = s.param2
		minetest.env:set_node(p, {name="stones:asetr", param2=p2asru}) end
        if s.name == "stones:asectr"	then 
		p2ascr2 = s.param2
		minetest.env:set_node(p, {name="stones:asectr_2", param2=p2ascr2}) end
		...
		p2ascru = s.param2
		minetest.env:set_node(p, {name="stones:asectr", param2=p2ascru}) end
        if s.name == "stones:sku_202"	then 
		p2sk27l = s.param2
		minetest.env:set_node(p, {name="stones:sku_207l", param2=p2sk27l}) end
        if s.name == "stones:sku_207l"	then 
		p2sk7lr = s.param2
		minetest.env:set_node(p, {name="stones:sku_207r", param2=p2sk7lr}) end
        if s.name == "stones:sku_207r"	then 
		p2sk7r2 = s.param2
		minetest.env:set_node(p, {name="stones:sku_202", param2=p2sk7r2}) end
        if s.name == "stones:skub_202"	then 
		p2skb27l = s.param2
		minetest.env:set_node(p, {name="stones:skub_207l", param2=p2skb27l}) end
        if s.name == "stones:skub_207l"	then 
		p2skb7lr = s.param2
		minetest.env:set_node(p, {name="stones:skub_207r", param2=p2skb7lr}) end
		...
		p2cl7 = s.param2
		minetest.env:set_node(p, {name="tool:door_r52", param2=p2cl7}) end
        if s.name == "tool:door_r52"	then 
		p2cl8 = s.param2
		minetest.env:set_node(p, {name="tool:door_l52", param2=p2cl8}) end
        if s.name == "tool:door_l52"	then 
		p2cl9 = s.param2
		minetest.env:set_node(p, {name="tool:door_r52a", param2=p2cl9}) end
        if s.name == "tool:door_r52a"	then 
		p2cl10 = s.param2
		...
		p2op7 = s.param2
		minetest.env:set_node(p, {name="tool:door_r52o", param2=p2op7}) end
        if s.name == "tool:door_r52o"	then 
		p2op8 = s.param2
		minetest.env:set_node(p, {name="tool:door_l52o", param2=p2op8}) end
        if s.name == "tool:door_l52o"	then 
		p2op9 = s.param2
		minetest.env:set_node(p, {name="tool:door_r52ao", param2=p2op9}) end
        if s.name == "tool:door_r52ao"	then 
		p2op10 = s.param2
		...
		p2winde = s.param2
		minetest.env:set_node(p, {name="tool:window_closed_e", param2=p2winde}) end
		...
		p2y2a = s.param2
		minetest.env:set_node(p, {name="stones:pyra", param2=p2y2a}) end
...
--		minetest.env:set_node(p, {name="runes:hui", param2=p2lh}) end
		...
		p2br3 = s.param2
		minetest.env:set_node(p, {name="stones:r_3", param2=p2br3}) end
        if s.name == "stones:brush_4"	then 
		p2br4 = s.param2
		minetest.env:set_node(p, {name="stones:r_4", param2=p2br4}) end
        if s.name == "stones:brushrock_1"	then 
		p2br1 = s.param2
        ...
        if s.name == "stones:brushrock_2v"	then 
		p2br2v = s.param2
		minetest.env:set_node(p, {name="stones:rushrock_2v", param2=p2br2v}) end
        if s.name == "stones:brushrock_3"	then 
		p2br3 = s.param2
        ...
        if s.name == "stones:s_52dkl"	then 
		p2sb52dkla = s.param2
		minetest.env:set_node(p, {name="stones:sb_52dkl", param2=p2sb52dkla}) end
        if s.name == "stones:sb_52dkl"	then 
		p2sb52dklb = s.param2
		minetest.env:set_node(p, {name="stones:s_52dkl", param2=p2sb52dklb}) end
        if s.name == "stones:s_52dkr"	then 
		p2sb52dkra = s.param2
		minetest.env:set_node(p, {name="stones:sb_52dkr", param2=p2sb52dkra}) end
        if s.name == "stones:sb_52dkr"	then 
		p2sb52dkrb = s.param2
		minetest.env:set_node(p, {name="stones:s_52dkr", param2=p2sb52dkrb}) end
        ...
        if s.name == "stones:s_52kl"	then 
		p2sb52kla = s.param2
		minetest.env:set_node(p, {name="stones:sb_52kl", param2=p2sb52kla}) end
        if s.name == "stones:sb_52kl"	then 
		p2sb52klb = s.param2
        ...
        if s.name == "stones:s_52kr"	then 
		p2sb52kra = s.param2
		minetest.env:set_node(p, {name="stones:sb_52kr", param2=p2sb52kra}) end
        if s.name == "stones:sb_52kr"	then 
		p2sb52krb = s.param2
        ...
        if s.name == "stones:sukz"	then 
		p2skuz = s.param2
		minetest.env:set_node(p, {name="stones:skuz", param2=p2skuz}) end
        if s.name == "stones:sku20c"	then 
		p2sk02c = s.param2
		minetest.env:set_node(p, {name="stones:sk0bl2c", param2=p2sk02c}) end
        if s.name == "stones:sk0bl2c"	then 
		p2sb20c = s.param2
		minetest.env:set_node(p, {name="stones:sku20c", param2=p2sb20c}) end
        if s.name == "stones:sku2_r"	then 
		p2sk2a = s.param2
        ...
        if s.name == "stones:sku2_rc"	then 
		p2skca = s.param2
		minetest.env:set_node(p, {name="stones:skub2_rc", param2=p2skca}) end
        if s.name == "stones:skub2_rc"	then 
		p2skcb = s.param2
		minetest.env:set_node(p, {name="stones:sku2_rc", param2=p2skcb}) end
        if s.name == "stones:skus_lc"	then 
		p2sksa = s.param2
		minetest.env:set_node(p, {name="stones:skubs_lc", param2=p2sksa}) end
        if s.name == "stones:skubs_lc"	then 
		p2sksb = s.param2
		minetest.env:set_node(p, {name="stones:skus_lc", param2=p2sksb}) end
        if s.name == "stones:sku2_rk"	then 
		p2skb = s.param2
		minetest.env:set_node(p, {name="stones:skub2_rk", param2=p2skb}) end
        if s.name == "stones:skub2_rk"	then 
		p2sbk = s.param2
		minetest.env:set_node(p, {name="stones:sku2_rk", param2=p2sbk}) end
        if s.name == "stones:sku2_l"	then 
		p2sk3a = s.param2
        ...
        if s.name == "stones:sku2_lc"	then 
		p2sk3ca = s.param2
		minetest.env:set_node(p, {name="stones:skub2_lc", param2=p2sk3ca}) end
        if s.name == "stones:skub2_lc"	then 
		p2sk3cb = s.param2
		minetest.env:set_node(p, {name="stones:sku2_lc", param2=p2sk3cb}) end
        if s.name == "stones:skus_rc"	then 
		p2sk3sa = s.param2
		minetest.env:set_node(p, {name="stones:skubs_rc", param2=p2sk3sa}) end
        if s.name == "stones:skubs_rc"	then 
		p2sk3sb = s.param2
		minetest.env:set_node(p, {name="stones:skus_rc", param2=p2sk3sb}) end
        if s.name == "stones:sku2_lk"	then 
		p2skb = s.param2
		minetest.env:set_node(p, {name="stones:skub2_lk", param2=p2skb}) end
        if s.name == "stones:skub2_lk"	then 
		p2sbk = s.param2
		minetest.env:set_node(p, {name="stones:sku2_lk", param2=p2sbk}) end
        ...
        if s.name == "stones:sku_207l"	then 
		p2sk7la = s.param2
		minetest.env:set_node(p, {name="stones:skub_207l", param2=p2sk7la}) end
        if s.name == "stones:skub_207l"	then 
		p2sk7lb = s.param2
		minetest.env:set_node(p, {name="stones:sku_207l", param2=p2sk7lb}) end
        if s.name == "stones:sku_207r"	then 
		p2sk7ra = s.param2
		minetest.env:set_node(p, {name="stones:skub_207r", param2=p2sk7ra}) end
        if s.name == "stones:skub_207r"	then 
		p2sk7rb = s.param2
		minetest.env:set_node(p, {name="stones:sku_207r", param2=p2sk7rb}) end
        ...
        if s.name == "stones:s_52ukl"	then 
		p2s52kla = s.param2
		minetest.env:set_node(p, {name="stones:s_52bukl", param2=p2s52kla}) end
        if s.name == "stones:s_52bukl"	then 
		p2s52klb = s.param2
		minetest.env:set_node(p, {name="stones:s_52ukl", param2=p2s52klb}) end
        if s.name == "stones:s_52ukr"	then 
		p2s52kra = s.param2
		minetest.env:set_node(p, {name="stones:s_52bukr", param2=p2s52kra}) end
        if s.name == "stones:s_52bukr"	then 
		p2s52krb = s.param2
		minetest.env:set_node(p, {name="stones:s_52ukr", param2=p2s52krb}) end
        ...
        if s.name == "stones:s_62ur"	then 
		p262ua = s.param2
		minetest.env:set_node(p, {name="stones:sb_62ur", param2=p262ua}) end
        if s.name == "stones:sb_62ur"	then 
		p262ub = s.param2
		minetest.env:set_node(p, {name="stones:s_62ur", param2=p262ub}) end
        if s.name == "stones:s_62r"	then 
		p262a = s.param2
		minetest.env:set_node(p, {name="stones:sb_62r", param2=p262la}) end
        if s.name == "stones:sb_62r"	then 
		p262b = s.param2
		minetest.env:set_node(p, {name="stones:s_62r", param2=p262b}) end
        if s.name == "stones:s_62ul"	then 
		p262uc = s.param2
		minetest.env:set_node(p, {name="stones:sb_62ul", param2=p262uc}) end
        if s.name == "stones:sb_62ul"	then 
		p262ud = s.param2
		minetest.env:set_node(p, {name="stones:s_52ul", param2=p262ud}) end
        if s.name == "stones:s_62l"	then 
		p262c = s.param2
		minetest.env:set_node(p, {name="stones:sb_62l", param2=p262c}) end
        if s.name == "stones:sb_62l"	then 
		p262d = s.param2
		minetest.env:set_node(p, {name="stones:s_52l", param2=p262d}) end
        if s.name == "stones:s_3hjr"	then 
		p2hja = s.param2
        ...
        if s.name == "stones:diagsteps_43l"	then 
		p2r43lk = s.param2
		minetest.env:set_node(p, {name="stones:diagsterps_43l", param2=p2r43lk}) end
        if s.name == "stones:diagsterps_43l"	then 
		p243lku = s.param2
		minetest.env:set_node(p, {name="stones:diagsteps_43l", param2=p243lku}) end
        if s.name == "stones:diagsteps_43r"	then 
		p2r43rk = s.param2
		minetest.env:set_node(p, {name="stones:diagsterps_43r", param2=p2r43rk}) end
        if s.name == "stones:diagsterps_43r"	then 
		p243rku = s.param2
		minetest.env:set_node(p, {name="stones:diagsteps_43r", param2=p243rku}) end
        if s.name == "stones:skus_r"	then 
		p2sbr = s.param2
        ...
        if s.name == "stones:s_52uk"	then 
		p252ukr = s.param2
		minetest.env:set_node(p, {name="stones:s_52urk", param2=p252ukr}) end
        if s.name == "stones:s_52urk"	then 
		p252urk = s.param2
		minetest.env:set_node(p, {name="stones:s_52uk", param2=p252urk}) end
        if s.name == "stones:s_52vk"	then 
		p252vkr = s.param2
		minetest.env:set_node(p, {name="stones:s_52vrk", param2=p252vkr}) end
        if s.name == "stones:s_52vrk"	then 
		p252vrk = s.param2
        ...
        if s.name == "stones:blushrock_2v"	then 
		p2r2uxbl = s.param2
		minetest.env:set_node(p, {name="stones:blushrock_2u", param2=p2r2uxbl}) end
        if s.name == "stones:blushrock_21u"	then 
		p2r21uxbl = s.param2
		minetest.env:set_node(p, {name="stones:blushrock_21", param2=p2r21uxbl}) end
        if s.name == "stones:blushrock_21"	then 
		p2r21ubl = s.param2
		minetest.env:set_node(p, {name="stones:blushrock_21u", param2=p2r21ubl}) end
        if s.name == "stones:blushrock_52ur"	then 
		p2rc = s.param2
		minetest.env:set_node(p, {name="stones:blushrock_527r", param2=p2rc}) end
        if s.name == "stones:blushrock_52ul"	then 
		p2rc = s.param2
		minetest.env:set_node(p, {name="stones:blushrock_527l", param2=p2rc}) end
        if s.name == "stones:blushrock_28"	then 
		p2rc = s.param2
		minetest.env:set_node(p, {name="stones:blushrock_2u", param2=p2rc}) end
        if s.name == "stones:blushrock_527r"	then 
		p2rc = s.param2
		minetest.env:set_node(p, {name="stones:blushrock_52ur", param2=p2rc}) end
        if s.name == "stones:blushrock_527l"	then 
		p2rc = s.param2
		minetest.env:set_node(p, {name="stones:blushrock_52ul", param2=p2rc}) end
        if s.name == "stones:blushrock_2u"	then 
		p2rc = s.param2
		minetest.env:set_node(p, {name="stones:blushrock_28", param2=p2rc}) end

...
minetest.register_node("tool:bars_a", {
	...
	paramtype2 = "facedir",
	tiles = {"kopper.png"},
	inventory_image = "bars.png^dice_00.png",
	wield_image = "bars.png^dice_00.png",
...
{-0.0625,-0.5,-0.375, 0.0625,0.5,-0.25},
...
{-0.375,0.4375,-0.375, -0.25,0.5,-0.25},
{-0.0625,-0.5,-0.375, 0.0625,-0.375,-0.25},
{-0.0625,0.4375,-0.375, 0.0625,0.5,-0.25},
{0.25,-0.5,-0.375, 0.375,-0.4375,-0.25},
{0.25,0.375,-0.375, 0.375,0.5,-0.25}}},
	on_rightclick = function(pos, node, clicker, pointed_thing)
...
{-0.0625,-0.5,-0.375, 0.0625,-0.4375,-0.25},
{0.25,-0.5,-0.375, 0.375,-0.4375,-0.25}}},
	on_rightclick = function(pos, node, clicker, pointed_thing)
...
minetest.register_node("tool:bars_d", {
	...
	climbable = true,
	node_box = {type="fixed",fixed={
{-0.375,0.375,-0.375, -0.25,0.5,-0.25},
{-0.0625,0.4375,-0.375, 0.0625,0.5,-0.25},
{0.25,0.375,-0.375, 0.375,0.5,-0.25}}},
	on_rightclick = function(pos, node, clicker, pointed_thing)
...
minetest.register_node("tool:bars_e", {
	...
	climbable = true,
	node_box = {type="fixed",fixed={
{-0.375,-0.5,-0.375, -0.25,1.49,-0.25},
{-0.0625,-0.5,-0.375, 0.0625,1.49,-0.25},
{0.25,-0.5,-0.375, 0.375,1.49,-0.25}}},
	on_rightclick = function(pos, node, clicker, pointed_thing)
...
minetest.register_node("tool:bars_2a", {
	...
	paramtype2 = "facedir",
	tiles = {"kopper.png"},
	inventory_image = "bars.png^dice_01.png",
	wield_image = "bars.png^dice_01.png",
	groups = {cracky=1, oddly_breakable_by_hand=1,not_in_creative_inventory=1},
	drop = "tool:bars_2a",
	drawtype = "nodebox",
	sunlight_propagates = true,
...
minetest.register_node("tool:bars_3a", {
	...
	paramtype2 = "facedir",
	tiles = {"kopper.png"},
	inventory_image = "bars.png^dice_02.png",
	wield_image = "bars.png^dice_02.png",
	groups = {cracky=1, oddly_breakable_by_hand=1,not_in_creative_inventory=1},
	drop = "tool:bars_3a",
	drawtype = "nodebox",
	sunlight_propagates = true,
...
minetest.register_node("tool:bars_4a", {
	...
	paramtype2 = "facedir",
	tiles = {"kopper.png"},
	inventory_image = "bars.png^dice_03.png",
	wield_image = "bars.png^dice_03.png",
	groups = {cracky=1, oddly_breakable_by_hand=1,not_in_creative_inventory=1},
	drop = "tool:bars_4a",
	drawtype = "nodebox",
	sunlight_propagates = true,
...
minetest.register_node("tool:bars_5a", {
	...
	paramtype2 = "facedir",
	tiles = {"kopper.png"},
	inventory_image = "bars.png^dice_08.png",
	wield_image = "bars.png^dice_08.png",
	groups = {cracky=1, oddly_breakable_by_hand=1,not_in_creative_inventory=1},
	drop = "tool:bars_5a",
	drawtype = "nodebox",
	sunlight_propagates = true,
...
{0.3125,0.4375,0.0625, 0.4375,0.5,0.1875}}},
	on_rightclick = function(pos, node, clicker, pointed_thing)
...
minetest.register_node("tool:bars_6a", {
	...
	paramtype2 = "facedir",
	tiles = {"kopper.png"},
	inventory_image = "bars.png^dice_09.png",
	wield_image = "bars.png^dice_09.png",
	groups = {cracky=1, oddly_breakable_by_hand=1,not_in_creative_inventory=1},
	drop = "tool:bars_6a",
	drawtype = "nodebox",
	sunlight_propagates = true,
...
minetest.register_node("tool:window_closed", {
	...
	paramtype2 = "facedir",
	tiles = {"window.png"},
	inventory_image = "window0.png^dice_16.png",
	wield_image = "window0.png^dice_16.png",
	groups = {cracky=1, oddly_breakable_by_hand=1,not_in_creative_inventory=0},
...
minetest.register_node("tool:window_closed_a", {
	...
	paramtype2 = "facedir",
	tiles = {"window.png"},
	inventory_image = "window0.png^dice_01.png",
	wield_image = "window0.png^dice_01.png",
	groups = {cracky=1, oddly_breakable_by_hand=1,not_in_creative_inventory=1},
...
minetest.register_node("tool:window_closed_b", {
	...
	paramtype2 = "facedir",
	tiles = {"window.png"},
	inventory_image = "window0.png^dice_04.png",
	wield_image = "window0.png^dice_04.png",
	groups = {cracky=1, oddly_breakable_by_hand=1,not_in_creative_inventory=1},
...
minetest.register_node("tool:window_closed_c", {
	...
	paramtype2 = "facedir",
	tiles = {"window.png"},
	inventory_image = "window0.png^dice_05.png",
	wield_image = "window0.png^dice_05.png",
	groups = {cracky=1, oddly_breakable_by_hand=1,not_in_creative_inventory=1},
...
minetest.register_node("tool:window_closed_d", {
	...
	paramtype2 = "facedir",
	tiles = {"window.png"},
	inventory_image = "window0.png^dice_08.png",
	wield_image = "window0.png^dice_08.png",
	groups = {cracky=1, oddly_breakable_by_hand=1,not_in_creative_inventory=1},
...
minetest.register_node("tool:window_closed_e", {
	...
	paramtype2 = "facedir",
	tiles = {"window.png"},
	inventory_image = "window0.png^dice_09.png",
	wield_image = "window0.png^dice_09.png",
	groups = {cracky=1, oddly_breakable_by_hand=1,not_in_creative_inventory=1},
